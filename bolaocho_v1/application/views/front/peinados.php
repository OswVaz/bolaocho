<style type="text/css">
    #peinados_sec_1 {background-image: url("<?= base_url($img_1)?>");}
    #peinados_sec_2 {background-image: url("<?= base_url($img_2)?>");}
</style>
<section id="peinados_sec_1">
	<div class="vifio">
		<div class="rel1 text-center">
			<div class="rel01">
				<br>
				<h1 class="rel2 tx2">Peinados</h1>
...
<section id="peinados_sec_2">
	<div class="divserv text-center center-block">
		<br><p class="texq"><?=$text_2?></p>
		<div class="row">
